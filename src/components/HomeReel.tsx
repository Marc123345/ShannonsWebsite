...
export function HomeReel() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative md:h-screen min-h-screen w-full overflow-hidden bg-black"
    >
      <div className="absolute inset-0">
        <video
          ref={videoRef}
          className="absolute inset-0 w-full h-full object-cover md:opacity-0 opacity-100"
          autoPlay
          loop
          muted
          playsInline
      ...
      >
        <div className="text-center max-w-7xl mx-auto">
          <div ref={line2Ref} className="absolute inset-0 flex items-center justify-center md:opacity-0 opacity-100">
          ...
          <div ref={line3Ref} className="absolute inset-0 flex items-center justify-center md:opacity-0 hidden md:flex">
